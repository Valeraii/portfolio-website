    ...
    return (
        <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
                ...
                <span className={`bg-dark dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm translate-y-0.5 ${isOpen ? '-rotate-45 -translate-y-1' : 'translte-y-0.5'}`}> </span>
            </button>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap mt-2'>
                            <motion.a href="https://github.com/Valeraii" target={"_blank"}
                                whileHover={{y:-2}}
                                whileTap={{scale: 0.9}}
                                className="w-6 mx-3 bg-;light rounded-full dark:bg-dark">
                                <GithubIcon/>
                            </motion.a>
                            <motion.a href="https://www.linkedin.com/in/valerie-yh-tan" target={"_blank"}
                                whileHover={{y:-2}}
                                whileTap={{scale: 0.9}}
                                className="w-6 ml-3 mr-2">
                                <LinkedInIcon/>
                            </motion.a>
                    ...
                    <motion.div
                        ...
                        <nav className='flex items-center justify-center flex-wrap mt-2'>
                            ...
                            <motion.a href="https://www.linkedin.com/in/valerie-yh-tan" target={"_blank"}
                                whileHover={{y:-2}}
                                whileTap={{scale: 0.9}}
                                className="w-6 ml-3 mr-2 sm:mx-1">
                                <LinkedInIcon/>
                            </motion.a>
                            <button onClick={() => setMode(mode === "light" ? "dark" : "light")}
                                className={`ml-3 flex items-center justify-center rounded-full p-1
